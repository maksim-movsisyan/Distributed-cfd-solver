...
[[nodiscard]] constexpr AuxConnType operator|(AuxConnType a, AuxConnType b) noexcept {
...
[[nodiscard]] constexpr bool has_flag(AuxConnType mask, AuxConnType flag) noexcept {
