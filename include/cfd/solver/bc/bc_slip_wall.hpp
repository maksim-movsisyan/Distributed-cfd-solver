...
/** @brief Set value in ghost cell for Slip / Symmetry boundary */
inline void slip_wall_kernel(fields::PrimitiveView<double> s,
...
/** @brief Set gradient in ghost cell for Slip / Symmetry boundary */
inline void slip_wall_grad_kernel(fields::ConstPrimitiveView s,
...
public:
    ...
    void apply(fields::PrimitiveView<double> state,
        ...
        slip_wall_kernel(state, mesh, this->m_begin, this->m_end);
    }
    ...
    void apply_grad(fields::ConstPrimitiveView state,
        ...
        slip_wall_grad_kernel(state, state_grad, mesh, this->m_begin, this->m_end);
    }
