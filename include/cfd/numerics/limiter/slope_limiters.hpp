...
/**
 * @brief Second-order Unlimited.
 */
struct Unlimited {
    static constexpr const char* name() noexcept { return "UNLIMITED"; }
...
static_assert(MultidimSlopeLimiter<BarthJespersen>);
static_assert(MultidimSlopeLimiter<Venkatakrishnan>);
static_assert(MultidimSlopeLimiter<VanAlbada>);
static_assert(MultidimSlopeLimiter<Unlimited>);
